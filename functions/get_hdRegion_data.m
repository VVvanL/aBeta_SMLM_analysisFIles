function data = get_hdRegion_data(XY, psd, nano, a, C, threshold, P, R)
    ...
    num_reg2 = numRegions(nano{P}); hdr_overlap = cell(num_reg2,num_reg1);
    for n2 = 1:num_reg2
        for n1 = 1:num_reg1
    ...
    data.hdr_overlap = hdr_overlap; % hd-regions overlap (recpt. hdrs, psd hdrs)
